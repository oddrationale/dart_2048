...
["dart.core", "dart:core", , P, {
  ...
  num__returnNull: [function(_) {
    return;
  }, "call$1", "num__returnNull$closure", 2, 0, 8],
...
["dart.dom.html", "dart:html", , W, {
  ...
  TouchEvent: {
    "^": "UIEvent;altKey=,ctrlKey=,metaKey=,shiftKey=,touches=",
    "%": "TouchEvent"
  },
  TouchList: {
...
["dart_2048", "main.dart", , R, {
  "^": "",
  main: [function() {
    var t1 = window;
    C.Window_methods._ensureRequestAnimationFrame$0(t1);
    C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(new R.main_closure()));
  }, "call$0", "main$closure", 0, 0, 2],
  main_closure: {
    "^": "Closure:8;",
    call$1: function(_) {
      var t1 = new T.KeyboardInputManager(null, null, null);
      t1.listen$0();
      new V.GameManager(4, 2, null, 0, false, false, false, t1, new Y.LocalStorageManager("bestScore", "gameState", window.localStorage), new Y.HTMLActuator(document.querySelector(".tile-container"), document.querySelector(".score-container"), document.querySelector(".best-container"), document.querySelector(".game-message"), 0)).GameManager$1(4);
    }
  }
},
1],
["dart_2048.game_manager", "package:dart_2048/game_manager.dart", , V, {
  "^": "",
  GameManager: {
    "^": "Object;size,startTiles,grid,score,over,won,keepPlaying,inputManager,storageManager,actuator",
    restart$0: [function() {
      var t1 = this.storageManager;
      J.remove$1$ax(t1.storage, t1.gameStateKey);
      this.actuator.clearMessage$0();
      this.setup$0();
    }, "call$0", "get$restart", 0, 0, 2],
    continuePlaying$0: [function() {
      this.keepPlaying = true;
      this.actuator.clearMessage$0();
    }, "call$0", "get$continuePlaying", 0, 0, 2],
    setup$0: function() {
      var previousState, t1;
      previousState = this.storageManager.getGameState$0();
      if (previousState != null) {
        t1 = J.getInterceptor$asx(previousState);
        this.grid = t1.$index(previousState, "grid");
        this.score = t1.$index(previousState, "score");
        this.over = t1.$index(previousState, "over");
        this.won = t1.$index(previousState, "won");
        this.keepPlaying = t1.$index(previousState, "keepPlaying");
      } else {
        this.grid = V.Grid$(this.size);
        this.score = 0;
        this.over = false;
        this.won = false;
    ...
    addStartTiles$0: function() {
      var t1, i;
      for (t1 = this.startTiles, i = 0; i < t1; ++i)
        this.addRandomTile$0();
    },
    addRandomTile$0: function() {
      var value, t1;
      if (this.grid.cellsAvailable$0()) {
        value = C.C__JSRandom.nextDouble$0() < 0.9 ? 2 : 4;
        t1 = this.grid.randomAvailableCell$0();
        this.grid.insertTile$1(new G.Tile(t1, null, value, null));
      }
    },
    actuate$0: function() {
      var t1, t2, t3, t4, t5, t6;
      t1 = this.storageManager;
      if (J.$lt$n(t1.getBestScore$0(), this.score))
        t1.storage.setItem(t1.bestScoreKey, H.S(this.score));
      t2 = t1.storage;
      t3 = t1.gameStateKey;
      if (this.over === true)
        J.remove$1$ax(t2, t3);
      else
        t2.setItem(t3, C.JsonCodec_null_null.encode$1(this.toJson$0()));
      t2 = this.grid;
      t3 = this.score;
      t4 = this.over;
      t5 = this.won;
      t1 = t1.getBestScore$0();
      if (this.over !== true)
        t6 = this.won === true && this.keepPlaying !== true;
      else
        t6 = true;
      this.actuator.actuate$2(t2, P.LinkedHashMap_LinkedHashMap$_literal(["score", t3, "over", t4, "won", t5, "bestScore", t1, "terminated", t6], null, null));
    },
    toJson$0: function() {
      return P.LinkedHashMap_LinkedHashMap$_literal(["grid", this.grid, "score", this.score, "over", this.over, "won", this.won, "keepPlaying", this.keepPlaying], null, null);
    },
    prepareTiles$0: function() {
      this.grid.eachCell$1(new V.GameManager_prepareTiles_closure());
    },
    move$1: [function(direction) {
      var t1, t2, vector, traversals;
      t1 = {};
      if (this.over !== true)
        t2 = this.won === true && this.keepPlaying !== true;
      else
        t2 = true;
      if (t2)
        return;
      ...
      t1.moved_2 = false;
      this.prepareTiles$0();
      J.forEach$1$ax(traversals.$index(0, "x"), new V.GameManager_move_closure(t1, this, vector, traversals));
      if (t1.moved_2) {
        this.addRandomTile$0();
        if (!(this.grid.cellsAvailable$0() || this.tileMatchesAvailable$0()))
          this.over = true;
        this.actuate$0();
      }
    }, "call$1", "get$move", 2, 0, 21],
    getVector$1: function(direction) {
      return P.LinkedHashMap_LinkedHashMap$_literal([0, new G.Position(0, -1), 1, new G.Position(1, 0), 2, new G.Position(0, 1), 3, new G.Position(-1, 0)], null, null).$index(0, direction);
    },
    buildTraversals$1: function(vector) {
      var traversals, pos;
      traversals = P.LinkedHashMap_LinkedHashMap$_literal(["x", [], "y", []], null, null);
      for (pos = 0; pos < this.size; ++pos) {
        J.add$1$ax(traversals.$index(0, "x"), pos);
        J.add$1$ax(traversals.$index(0, "y"), pos);
      }
      if (J.$eq(vector.x, 1))
        traversals.$indexSet(0, "x", J.get$reversed$ax(traversals.$index(0, "x")));
      if (J.$eq(vector.y, 1))
        traversals.$indexSet(0, "y", J.get$reversed$ax(traversals.$index(0, "y")));
      return traversals;
    },
    findFarthestPosition$2: function(cell, vector) {
      var cell0;
      do {
        cell0 = new G.Position(J.$add$ns(cell.x, vector.x), J.$add$ns(cell.y, vector.y));
        if (this.grid.withinBounds$1(cell0) && this.grid.cellAvailable$1(cell0)) {
          cell = cell0;
          continue;
        } else
          break;
      } while (true);
      return P.LinkedHashMap_LinkedHashMap$_literal(["farthest", cell, "next", cell0], null, null);
    },
    tileMatchesAvailable$0: function() {
      var tile, x, y, t1, direction, vector, t2, t3, other;
      for (tile = null, x = 0; x < this.size; ++x)
        for (y = 0; y < this.size; ++y) {
          tile = this.grid.cellContent$1(new G.Position(x, y));
          if (tile != null)
            for (t1 = J.getInterceptor$x(tile), direction = 0; direction < 4; ++direction) {
              vector = this.getVector$1(direction);
              t2 = vector.x;
              if (typeof t2 !== "number")
                return H.iae(t2);
              ...
              if (typeof t3 !== "number")
                return H.iae(t3);
              other = this.grid.cellContent$1(new G.Position(x + t2, y + t3));
              if (other != null && J.$eq(J.get$value$x(other), t1.get$value(tile)))
                return true;
            }
        }
      return false;
    ...
    GameManager$1: function(size) {
      var t1;
      this.size = size;
      t1 = this.inputManager;
      t1.moveEvent = this.get$move();
      t1.restartEvent = this.get$restart();
      t1.keepPlayingEvent = this.get$continuePlaying();
      this.setup$0();
    }
  },
  GameManager_prepareTiles_closure: {
    "^": "Closure:22;",
    call$3: function(x, y, tile) {
      if (tile != null) {
        tile.set$mergedFrom(null);
        tile.previousPosition = new G.Position(J.get$x$x(tile.position), J.get$y$x(tile.position));
      }
    }
  },
  GameManager_move_closure: {
    "^": "Closure:23;box_0,this_1,vector_2,traversals_3",
    call$1: function(x) {
      J.forEach$1$ax(this.traversals_3.$index(0, "y"), new V.GameManager_move__closure(this.box_0, this.this_1, this.vector_2, x));
    }
  },
  GameManager_move__closure: {
    "^": "Closure:23;box_0,this_4,vector_5,x_6",
    call$1: function(y) {
      var cell, t1, t2, tile, positions, next, merged, t3, t4, t5;
      cell = new G.Position(this.x_6, y);
      t1 = this.box_0;
      t1.cell_0 = cell;
      t2 = this.this_4;
      tile = t2.grid.cellContent$1(cell);
      t1.tile_1 = tile;
      if (tile != null) {
        positions = t2.findFarthestPosition$2(t1.cell_0, this.vector_5);
        next = t2.grid.cellContent$1(positions.$index(0, "next"));
        if (next != null && J.$eq(J.get$value$x(next), J.get$value$x(t1.tile_1)) && next.get$mergedFrom() == null) {
          merged = new G.Tile(positions.$index(0, "next"), null, J.$mul$ns(J.get$value$x(t1.tile_1), 2), null);
          merged.mergedFrom = [t1.tile_1, next];
          t2.grid.insertTile$1(merged);
          t2.grid.removeTile$1(t1.tile_1);
          t1.tile_1.updatePosition$1(positions.$index(0, "next"));
          t2.score = J.$add$ns(t2.score, merged.value);
          if (J.$eq(merged.value, 2048))
            t2.won = true;
        } else {
          t3 = t1.tile_1;
          t4 = positions.$index(0, "farthest");
          t5 = J.getInterceptor$x(t3);
          J.$indexSet$ax(J.$index$asx(J.get$cells$x(t2.grid), J.get$x$x(t5.get$position(t3))), J.get$y$x(t5.get$position(t3)), null);
          J.$indexSet$ax(J.$index$asx(J.get$cells$x(t2.grid), t4.x), t4.y, t3);
          t3.updatePosition$1(t4);
        }
        t2 = t1.cell_0;
        t3 = t1.tile_1;
        t4 = J.getInterceptor$x(t3);
        if (!(J.$eq(t2.x, J.get$x$x(t4.get$position(t3))) && J.$eq(t2.y, J.get$y$x(t4.get$position(t3)))))
          t1.moved_2 = true;
      }
    }
  }
}],
["dart_2048.grid", "package:dart_2048/src/grid.dart", , V, {
  "^": "",
  Grid: {
    "^": "Object;size,cells>",
    randomAvailableCell$0: function() {
      var availableCells, t1;
      availableCells = this.availableCells$0();
      t1 = availableCells.length;
      if (t1 === 0)
        return;
      t1 = C.C__JSRandom.nextInt$1(t1);
      if (t1 < 0 || t1 >= availableCells.length)
        return H.ioore(availableCells, t1);
      return availableCells[t1];
    },
    availableCells$0: function() {
      var availableCells = H.setRuntimeTypeInfo([], [G.Position]);
      this.eachCell$1(new V.Grid_availableCells_closure(availableCells));
      return availableCells;
    },
    eachCell$1: function(callback) {
      var x, t1, y;
      x = 0;
      while (true) {
        t1 = this.size;
        ...
        while (true) {
          ...
          if (!(y < t1))
            break;
          callback.call$3(x, y, J.$index$asx(J.$index$asx(this.cells, x), y));
          ++y;
        }
        ++x;
      }
    },
    cellsAvailable$0: function() {
      return this.availableCells$0().length > 0;
    },
    cellAvailable$1: function(cell) {
      return this.cellContent$1(cell) == null;
    },
    cellContent$1: function(cell) {
      if (!this.withinBounds$1(cell))
        return;
      return J.$index$asx(J.$index$asx(this.cells, cell.x), cell.y);
    },
    insertTile$1: function(tile) {
      J.$indexSet$ax(J.$index$asx(this.cells, J.get$x$x(tile.position)), J.get$y$x(tile.position), tile);
    },
    removeTile$1: function(tile) {
      var t1 = J.getInterceptor$x(tile);
      J.$indexSet$ax(J.$index$asx(this.cells, J.get$x$x(t1.get$position(tile))), J.get$y$x(t1.get$position(tile)), null);
    },
    ...
    toJson$0: function() {
      return P.LinkedHashMap_LinkedHashMap$_literal(["size", this.size, "cells", this.cells], null, null);
    },
    Grid$fromJson$1: function(json) {
      var t1 = J.getInterceptor$asx(json);
      this.size = t1.$index(json, "size");
      this.cells = t1.$index(json, "cells");
    },
    Grid$1: function(size) {
      this.size = size;
      this.cells = P.List_List$generate(size, new V.Grid_closure(size), true, P.List);
    },
    static: {Grid$: function(size) {
        var t1 = new V.Grid(null, null);
        t1.Grid$1(size);
        return t1;
      }}
  },
  Grid_closure: {
    "^": "Closure:8;size_0",
    call$1: function(_) {
      var t1 = Array(this.size_0);
      t1.fixed$length = init;
      return H.setRuntimeTypeInfo(t1, [G.Tile]);
    }
  },
  Grid_availableCells_closure: {
    "^": "Closure:22;availableCells_0",
    call$3: function(x, y, tile) {
      if (tile == null)
        this.availableCells_0.push(new G.Position(x, y));
    }
  }
}],
["dart_2048.html_actuator", "package:dart_2048/html_actuator.dart", , Y, {
  "^": "",
  HTMLActuator: {
    "^": "Object;tileContainer,scoreContainer,bestContainer,messageContainer,score",
    actuate$2: function(grid, metadata) {
      var t1 = window;
      C.Window_methods._ensureRequestAnimationFrame$0(t1);
      C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(new Y.HTMLActuator_actuate_closure(this, grid, metadata)));
    },
    addTile$1: function(tile) {
      var wrapper, inner, positionClass, classes, t1, t2;
      wrapper = document.createElement("div", null);
      inner = document.createElement("div", null);
      positionClass = this.positionClass$1(tile.get$previousPosition() != null ? tile.previousPosition : tile.position);
      classes = ["tile", "tile-" + H.S(tile.value), positionClass];
      if (J.$gt$n(tile.value, 2048))
        classes.push("tile-super");
      t1 = J.getInterceptor$x(wrapper);
      t1.set$classes(wrapper, classes);
      J.get$classes$x(inner).add$1(0, "tile-inner");
      inner.textContent = H.S(tile.value);
      if (tile.previousPosition != null) {
        t2 = window;
        C.Window_methods._ensureRequestAnimationFrame$0(t2);
        C.Window_methods._requestAnimationFrame$1(t2, W._wrapZone(new Y.HTMLActuator_addTile_closure(this, tile, wrapper, classes)));
      } else if (tile.mergedFrom != null) {
        classes.push("tile-merged");
        t1.set$classes(wrapper, classes);
        J.forEach$1$ax(tile.mergedFrom, new Y.HTMLActuator_addTile_closure0(this));
      } else {
        classes.push("tile-new");
        t1.set$classes(wrapper, classes);
      }
      t1.get$children(wrapper).add$1(0, inner);
      J.get$children$x(this.tileContainer).add$1(0, wrapper);
    },
    positionClass$1: function(position) {
      var t1, t2;
      t1 = J.getInterceptor$x(position);
      t2 = J.$add$ns(t1.get$x(position), 1);
      t1 = J.$add$ns(t1.get$y(position), 1);
      return "tile-position-" + H.S(t2) + "-" + H.S(t1);
    },
    ...
    clearMessage$0: function() {
      var t1, t2;
      t1 = this.messageContainer;
      t2 = J.getInterceptor$x(t1);
      t2.get$classes(t1).remove$1(0, "game-won");
      t2.get$classes(t1).remove$1(0, "game-over");
    }
  },
  HTMLActuator_actuate_closure: {
    "^": "Closure:8;this_0,grid_1,metadata_2",
    call$1: function(_) {
      var t1, t2, t3, t4, t5, difference, addition;
      t1 = this.this_0;
      J.get$children$x(t1.tileContainer).clear$0(0);
      this.grid_1.eachCell$1(new Y.HTMLActuator_actuate__closure(t1));
      t2 = this.metadata_2;
      t3 = t2.$index(0, "score");
      t4 = t1.scoreContainer;
      t5 = J.getInterceptor$x(t4);
      t5.get$children(t4).clear$0(0);
      difference = J.$sub$n(t3, t1.score);
      t1.score = t3;
      t4.textContent = H.S(t3);
      if (J.$gt$n(difference, 0)) {
        addition = document.createElement("div", null);
        J.get$classes$x(addition).add$1(0, "score-addition");
        addition.textContent = "+" + H.S(difference);
        t5.get$children(t4).add$1(0, addition);
      }
      t1.bestContainer.textContent = H.S(t2.$index(0, "bestScore"));
      if (t2.$index(0, "terminated") === true)
        if (t2.$index(0, "over") === true)
          t1.message$1(0, false);
        else if (t2.$index(0, "won") === true)
          t1.message$1(0, true);
    }
  },
  HTMLActuator_actuate__closure: {
    "^": "Closure:22;this_3",
    call$3: function(x, y, tile) {
      if (tile != null)
        this.this_3.addTile$1(tile);
    }
  },
  HTMLActuator_addTile_closure: {
    "^": "Closure:8;this_0,tile_1,wrapper_2,classes_3",
    call$1: function(_) {
      var t1, t2;
      t1 = this.classes_3;
      t2 = this.this_0.positionClass$1(this.tile_1.position);
      if (2 >= t1.length)
        return H.ioore(t1, 2);
      t1[2] = t2;
      J.set$classes$x(this.wrapper_2, t1);
    }
  },
  HTMLActuator_addTile_closure0: {
    "^": "Closure:8;this_4",
    call$1: function(merged) {
      this.this_4.addTile$1(merged);
    }
  }
}],
["dart_2048.keyboard_input_manager", "package:dart_2048/keyboard_input_manager.dart", , T, {
  "^": "",
  KeyboardInputManager: {
    "^": "Object;moveEvent,restartEvent,keepPlayingEvent",
    moveEvent$1: function(arg0) {
      return this.moveEvent.call$1(arg0);
    },
    restartEvent$0: function() {
      return this.restartEvent.call$0();
    },
    keepPlayingEvent$0: function() {
      return this.keepPlayingEvent.call$0();
    },
    listen$0: function() {
      var t1, map, t2, gameContainer;
      t1 = {};
      map = P.LinkedHashMap_LinkedHashMap$_literal([38, 0, 39, 1, 40, 2, 37, 3, 75, 0, 76, 1, 74, 2, 72, 3, 87, 0, 68, 1, 83, 2, 65, 3], null, null);
      t2 = H.setRuntimeTypeInfo(new W._EventStream(document, "keydown", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new T.KeyboardInputManager_listen_closure(this, map)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      this.bindButtonPress$2(".retry-button", this.get$restart());
      this.bindButtonPress$2(".restart-button", this.get$restart());
      this.bindButtonPress$2(".keep-playing-button", this.get$keepPlaying());
      t1.touchStartClientX_0 = null;
      t1.touchStartClientY_1 = null;
      gameContainer = document.querySelector(".game-container");
      gameContainer.toString;
      t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(gameContainer, "touchstart", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new T.KeyboardInputManager_listen_closure0(t1)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(gameContainer, "touchmove", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new T.KeyboardInputManager_listen_closure1()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(gameContainer, "touchend", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new T.KeyboardInputManager_listen_closure2(t1, this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    },
    restart$1: [function($event) {
      J.preventDefault$0$x($event);
      this.restartEvent$0();
    }, "call$1", "get$restart", 2, 0, 24],
    keepPlaying$1: [function($event) {
      J.preventDefault$0$x($event);
      this.keepPlayingEvent$0();
    }, "call$1", "get$keepPlaying", 2, 0, 24],
    bindButtonPress$2: function(selector, fn) {
      var button, t1;
      button = document.querySelector(selector);
      t1 = J.get$onClick$x(button);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(fn), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(button, "touchend", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(fn), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }
  },
  KeyboardInputManager_listen_closure: {
    "^": "Closure:25;this_1,map_2",
    call$1: function($event) {
      var t1, modifiers, mapped;
      t1 = J.getInterceptor$x($event);
      modifiers = t1.get$altKey($event) === true || t1.get$ctrlKey($event) === true || t1.get$metaKey($event) === true || t1.get$shiftKey($event) === true;
      mapped = this.map_2.$index(0, $event.which);
      t1 = !modifiers;
      if (t1 && mapped != null) {
        $event.preventDefault();
        this.this_1.moveEvent$1(mapped);
      }
      if (t1 && $event.which === 82) {
        $event.preventDefault();
        this.this_1.restartEvent$0();
      }
    }
  },
  KeyboardInputManager_listen_closure0: {
    "^": "Closure:26;box_0",
    call$1: function($event) {
      var t1, t2;
      ...
      t1 = t1[0];
      t2 = this.box_0;
      t2.touchStartClientX_0 = H.setRuntimeTypeInfo(new P.Point(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientX)), C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientY))), [null]).x;
      t1 = $event.touches;
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t1 = t1[0];
      t2.touchStartClientY_1 = H.setRuntimeTypeInfo(new P.Point(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientX)), C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientY))), [null]).y;
      $event.preventDefault();
    }
  },
  KeyboardInputManager_listen_closure1: {
    "^": "Closure:26;",
    call$1: function($event) {
      J.preventDefault$0$x($event);
    }
  },
  KeyboardInputManager_listen_closure2: {
    "^": "Closure:26;box_0,this_3",
    call$1: function($event) {
      var t1, touchEndClientX, touchEndClientY, t2, dx, absDx, dy, absDy;
      if (J.get$touches$x($event).length > 1)
        return;
      ...
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t1 = t1[0];
      touchEndClientX = H.setRuntimeTypeInfo(new P.Point(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientX)), C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientY))), [null]).x;
      t1 = $event.changedTouches;
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t1 = t1[0];
      touchEndClientY = H.setRuntimeTypeInfo(new P.Point(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientX)), C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientY))), [null]).y;
      t1 = this.box_0;
      t2 = t1.touchStartClientX_0;
      if (typeof touchEndClientX !== "number")
        return touchEndClientX.$sub();
      if (typeof t2 !== "number")
        return H.iae(t2);
      dx = touchEndClientX - t2;
      absDx = Math.abs(dx);
      t1 = t1.touchStartClientY_1;
      if (typeof touchEndClientY !== "number")
        return touchEndClientY.$sub();
      if (typeof t1 !== "number")
        return H.iae(t1);
      dy = touchEndClientY - t1;
      absDy = Math.abs(dy);
      if (P.max(absDx, absDy) > 10) {
        if (absDx > absDy)
          t1 = dx > 0 ? 1 : 3;
        else
          t1 = dy > 0 ? 2 : 0;
        this.this_3.moveEvent$1(t1);
      }
    }
  }
}],
["dart_2048.local_storage_manager", "package:dart_2048/local_storage_manager.dart", , Y, {
  "^": "",
  LocalStorageManager: {
    "^": "Object;bestScoreKey,gameStateKey,storage",
    getBestScore$0: function() {
      var t1, t2;
      t1 = this.storage;
      t2 = this.bestScoreKey;
      return t1.getItem(t2) != null ? P.num_parse(t1.getItem(t2), null) : 0;
    },
    getGameState$0: function() {
      var stateJSON = this.storage.getItem(this.gameStateKey);
      if (stateJSON == null)
        return;
      return C.JsonCodec_null_null.decode$2$reviver(stateJSON, new Y.LocalStorageManager_getGameState_closure());
    }
  },
  LocalStorageManager_getGameState_closure: {
    "^": "Closure:10;",
    call$2: function(key, value) {
      var t1 = J.getInterceptor(key);
      if (t1.$eq(key, "position")) {
        t1 = new G.Position(null, null);
        t1.Position$fromJson$1(value);
        return t1;
      } else if (typeof key === "number" && !!J.getInterceptor(value).$isMap) {
        t1 = new G.Tile(null, null, 2, null);
        t1.Tile$fromJson$1(value);
        return t1;
      } else if (t1.$eq(key, "grid")) {
        t1 = new V.Grid(null, null);
        t1.Grid$fromJson$1(value);
        return t1;
      } else
        return value;
    }
...
["dart_2048.tile", "package:dart_2048/src/tile.dart", , G, {
  "^": "",
  Position: {
    "^": "Object;x>,y>",
    toJson$0: function() {
      return P.LinkedHashMap_LinkedHashMap$_literal(["x", this.x, "y", this.y], null, null);
    },
    Position$fromJson$1: function(json) {
      var t1 = J.getInterceptor$asx(json);
      this.x = t1.$index(json, "x");
      this.y = t1.$index(json, "y");
    }
  },
  Tile: {
    "^": "Object;position>,previousPosition<,value>,mergedFrom@",
    updatePosition$1: function(position) {
      this.position = position;
    },
    toJson$0: function() {
      return P.LinkedHashMap_LinkedHashMap$_literal(["position", this.position, "value", this.value], null, null);
    },
    Tile$fromJson$1: function(json) {
      var t1 = J.getInterceptor$asx(json);
      this.position = t1.$index(json, "position");
...
{func: "dynamic__num_num_Tile", args: [P.num, P.num, G.Tile]},
